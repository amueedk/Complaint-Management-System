...
@app.route('/complaint/<int:complaint_id>/add_response', methods=['POST'])
@login_required
...
@app.route('/admin/hostel/new', methods=['GET', 'POST'])
@login_required
def new_hostel():
    if not current_user.is_admin:
        flash('You do not have permission to access this page')
...
@app.route('/admin/hostel/<int:hostel_id>/edit', methods=['GET', 'POST'])
@login_required
...
@app.route('/admin/hostel/<int:hostel_id>/delete', methods=['POST'])
@login_required
